            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="profile1">My Profile</a>
						...
						<div class="table-responsive">
							<table class="table table-striped custom-table">
								...
								<tbody>
									<tr>
										<td>APT0001</td>
										<td><img width="28" height="28" src="assetss/img/user.jpg" class="rounded-circle m-r-5" alt=""> Hritik pradesi</td>
										<td>35</td>
										<td> Dr.Cristana Dsouza</td>
										<td>Orthopedic</td>
										<td>30 Dec 2018</td>
									...
									<tr>
										<td>APT0002</td>
										<td><img width="28" height="28" src="assetss/img/user.jpg" class="rounded-circle m-r-5" alt=""> Sunil </td>
										<td>35</td>
										<td>Dr.Mukesh Budhwani</td>
									...
									<tr>
										<td>APT0003</td>
										<td><img width="28" height="28" src="assetss/img/user.jpg" class="rounded-circle m-r-5" alt=""> Jerry Thomas</td>
										<td>35</td>
										<td> Dr.Cristana Dsouza</td>
										<td>Orthopedic</td>
										<td>30 Dec 2018</td>
									...
									<tr>
										<td>APT0004</td>
										<td><img width="28" height="28" src="assetss/img/user.jpg" class="rounded-circle m-r-5" alt=""> MR.Bean</td>
										<td>35</td>
										<td> Dr.Megha Gosavi</td>
