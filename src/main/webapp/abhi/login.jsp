...
<head>
 <meta charset="utf-8">
    ...
    <!-- Favicon -->
    <link href="fas fa-heartbeat" rel="icon">
...
<style>
  ...
  background-image: url("assets/img/doctor4.jpg");
        ...
        <div class="row gx-0">
            ...
            <div class="col-md-6 text-center text-lg-end">
                <div class="position-relative d-inline-flex align-items-center bg-primary text-white top-shape px-5">
                    ...
                    <div class="py-2">
                        <p class="m-0"><i class="fa fa-phone-alt me-2"></i>+91 9404499667</p>
                    </div>
                </div>
            </div>
        </div>
...
<body>
    <div id="login">
        ...
        <h1 class="text-center text-black pt-5">Patient Login </h1>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="login_check" method="post">
                           ...
                           <div class="col-md-12 ">
                              <div class="login-or">
                                 ...
                                 <span class="span-or">or</span>
                                  <div class="form-group">
                              <p class="text-center">Don't have account? <a href="registration1" id="signup">Sign up here</a></p>
                           </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-white border-bottom" href="https://htmlcodex.com">Html.Spring</a><br>
                        Distributed by <a class="text-white border-bottom" href="https://themewagon.com">Team Backbenchers</a>              
                    </p>
                </div>
            </div>
        </div>
